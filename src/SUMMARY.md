...
# Stages
- [Instruction Fetch (`if`)](./stages/if.md)
- [Instruction Decode (`dec`)](./stages/dec.md)
- [Rename (`ren`)](./stages/ren.md)
- [Dispatch (`dis`)](./stages/dis.md)
- [Issue (`iss`)](./stages/iss.md)
- [Register Read (`rrd`)](./stages/rrd.md)
- [Execute (`exe`)](./stages/exe.md)
- [Memory (`mem`)](./stages/mem.md)
- [Sign Extend (`sxt`)](./stages/sxt.md)
- [Writeback (`wb`)](./stages/wb.md)
- [Commit (`com`)](./stages/com.md)
